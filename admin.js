...
if (!session || session.role !== 'admin') window.location.replace('./final-year-project-400l/login.html');
...
document.getElementById('logoutBtn').addEventListener('click', () => {
  sessionStorage.clear(); window.location.replace('./final-year-project-400l/login.html');
});
